-- Surfy TC2 - Bottom Drawer UI (FULLY FIXED)
...
function SurfyUI:CreateWindow(config)
    ...
    ConnectionLine.Size = UDim2.new(0, 2, 0, 0)
    ConnectionLine.Position = UDim2.new(0.5, -1, 1, -65)
    ...
    AddGradient(ConnectionLine, SurfyUI.Theme.PrimaryBright, SurfyUI.Theme.Primary, 90)
    ...
    function Window:Open()
        ...
        Tween(ConnectionLine, {Size = UDim2.new(0, 2, 0, 10), Position = UDim2.new(0.5, -1, 1, -75)}, 0.4, Enum.EasingStyle.Back)
    end
    ...
    function Window:Close()
        ...
        Tween(ConnectionLine, {Size = UDim2.new(0, 2, 0, 0), Position = UDim2.new(0.5, -1, 1, -65)}, 0.3, Enum.EasingStyle.Quint)
...
return SurfyUI or SurfyUI.Theme.Text}, 0.3)
...
function SurfyUI:CreateSectionHeader(section, config)
    config = config or {}
    ...
    function Module:Render(parent)
        ...
        SectionContainer.LayoutOrder = self.LayoutOrder
...
function SurfyUI:CreateToggleWithKeybind(section, config)
    ...
    function Module:Toggle()
        ...
        if self.Container then
            Tween(self.Indicator, {BackgroundTransparency = self.Enabled and 0 or 1}, 0.3)
            Tween(self.NameLabel, {TextColor3 = self.Enabled and SurfyUI.Theme.Primary

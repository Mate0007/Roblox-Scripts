...
function lib:Window(text, preset, closebind)
    ...
    local SeparatorLine = Instance.new("Frame") -- New separator line
    ...
    TabHold.Position = UDim2.new(0.0339285731, 0, 0.117335425, 0) -- Adjusted for title movement
    ...
    Title.Position = UDim2.new(0.0339285731, 0, 0.0264263314, 0) -- Moved up
    ...
    SeparatorLine.Position = UDim2.new(0.25, 0, 0.147, 0) -- Positioned to the left of content
    ...
    -- Mobile support: Create toggle button
    if isMobile then
        ...
        mobileToggleButton.Position = UDim2.new(0, 10, 0, 10) -- Top left but not fully corner
        ...
        function(io, p)
            if io.KeyCode == CloseBind then
                if uitoggled == false then
                    uitoggled = true
                    if isMobile then mobileToggleButton.Text = "Open" end
                    ...
                    uitoggled = false
                    ui.Enabled = true
                    if isMobile then mobileToggleButton.Text = "Close" end
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        -- Smooth corners for notification
        ...
        OkayBtnCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Button(text, callback)
            ...
            ButtonCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            ToggleCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameToggle1Corner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameToggle2Corner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameToggle3Corner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameToggleCircleCorner.CornerRadius = UDim.new(0, 5) -- Smoother corners
        ...
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            SliderCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            -- Smooth corners for slider track
        ...
        function tabcontent:Dropdown(text, list, callback)
            ...
            DropdownCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            for i, v in next, list do
                ...
                ItemCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            ColorpickerCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            BoxColorCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            ConfirmBtnCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            RainbowToggleCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameRainbowToggle1Corner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameRainbowToggle2.Position = UDim2.new(0.0489999987, 0, 0.112999998, 0)
            FrameRainbowToggle2.Size = UDim2.new(0, 33, 0, 14)

            FrameRainbowToggle2_2.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            FrameToggle3.CornerRadius = UDim.new(0, 6) -- Smoother corners
            FrameToggle3.Name = "FrameToggle3"
            ...
            FrameRainbowToggleCircleCorner.CornerRadius = UDim.new(0, 5) -- Smoother corners
            ...
            Color.Size = UDim2.new(0, 194, 0, 100) -- Increased height
            Color.ZIndex = 10
            Color.Image = "rbxassetid://4155801252"

            ColorCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            Hue.Size = UDim2.new(0, 25, 0, 100) -- Increased height
            Hue.ZIndex = 10

            HueCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
                ...
                function()
                    if ColorPickerToggled == false then
                        ...
                        Colorpicker:TweenSize(
                            UDim2.new(0, 363, 0, 182), -- Increased height for more space
                            Enum.EasingDirection.Out,
                            Enum.EasingStyle.Quart,
                            .2,
                            true
        ...
        function tabcontent:Label(text)
            ...
            LabelCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextboxCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
            ...
            TextboxFrameCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            BindCorner.CornerRadius = UDim.new(0, 6) -- Smoother corners
